...
const fetchUserCities = async (userId) => {
  const response = await fetch(`http://10.104.0.175:3000/api/users/${userId}/cities`);
...
const deleteUserCity = async (userId, cityName) => {
  ...
  const response = await fetch(`http://10.104.0.175:3000/api/users/${userId}/cities/name/${encodedCityName}`, {
    method: 'DELETE',
  });
